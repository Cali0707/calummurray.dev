...
export const metadata = {
  openGraph: {
    ...
    url: "https://calummurray.dev/blog/using-ai-as-a-student",
    siteName: "Calum Murray's Blog",
    images: [
      {
        url: "https://calummurray.dev/api/og?title=How I Would Use AI As A Student Today&image=https%3A%2F%2Fwww.calummurray.dev%2Fblog-images%2Fai.png", // Must be an absolute URL
        width: 1200,
        height: 630,
      },
    ],
