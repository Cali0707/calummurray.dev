        ...
        <div className="bg-[#e4e4e4] dark:bg-neutral-800/50 text-black dark:text-white font-bold p-6 flex flex-row justify-between text-lg" >
            ...
            <div className="flex gap-12">
                ...
                <div className="flex gap-4">
                    ...
                    <Link className="flex flex-col justify-center" href="https://linkedin.com/in/calum-ra-murray" target="_blank"><Image className="h-4 w-fit p-0 dark:invert" priority src={linkedinIcon} alt="Check out my LinkedIn profile" /></Link>
                </div>
            </div>
